...
<p align="center">
  <a href="https://yes-music-zeta.vercel.app/" target="blank">
    <img src="images/logo.png" alt="▶" width="156" height="156">
  </a>
  <h2 align="center" style="font-weight: 600">kemomiMusic</h2>

  <p align="center">
    高颜值的极简播放器
    <br />
    <a href="https://yes-music-zeta.vercel.app/" target="blank"><strong>🌎 访问DEMO</strong></a>&nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="#%EF%B8%8F-安装" target="blank"><strong>📦️ 下载安装包</strong></a>&nbsp;&nbsp;|&nbsp;&nbsp;
    <a href="https://t.me/kemomi" target="blank"><strong>💬 加入交流群</strong></a>
    <br />
    <br />
  </p>
</p>

[![Library][library-screenshot]](https://yes-music-zeta.vercel.app/)
...
本项目的 Demo (https://yes-music-zeta.vercel.app/) 就是部署在 Vercel 上的网站。
...
```sh
git clone --recursive https://github.com/kemomi/kemomiMusic.git
```
...
2. 使用 `git clone --recursive https://github.com/kemomi/kemomiMusic.git` 克隆本仓库到本地。
...
查看 Todo 请访问本项目的 [Projects](https://github.com/kemomi/kemomiMusic/projects/1)
